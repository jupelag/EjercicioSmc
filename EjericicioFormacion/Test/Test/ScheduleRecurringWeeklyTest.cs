...
namespace Test.Test
{
    public class ScheduleRecurringWeeklyTest
    {
        ...
        public void ScheduleRecurringWeekly_Hours_CurrentDay_BiggerThan_StartDate_Serie_Return_Correct_Dates()
        {
            ...
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 02, 06, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 02, 08, 00, 00));
            ...
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 13, 04, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 13, 06, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 13, 08, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 16, 04, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 16, 06, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 16, 08, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 17, 04, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 17, 06, 00, 00));
            calculator.GetNextExecutionTime(out _).Should().Be(new DateTime(2020, 01, 17, 08, 00, 00));
